...
static void m_handle_packet_pkg_offline(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
    if (data_length > 0) {
        return;
    }
...
static void m_handle_packet_pkg_nickname(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
...
static void m_handle_packet_pkg_statusmessage(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
...
static void m_handle_packet_pkg_userstatus(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
    if (data_length != 1) {
        return;
    }
...
static void m_handle_packet_pkg_typing(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
    if (data_length != 1) {
        return;
    }
...
static void m_handle_packet_pkg_message(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, const uint8_t message_type, void *userdata)
{
    if (data_length == 0) {
        return;
    }
...
static void m_handle_packet_pkg_invite_conference(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
    if (data_length == 0) {
        return;
    }
...
static void m_handle_packet_pkg_file_sendrequest(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
...
static void m_handle_packet_pkg_file_control(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
    if (data_length < 3) {
        return;
    }
...
static void m_handle_packet_pkg_file_data(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
    if (data_length < 1) {
        return;
    }
...
static void m_handle_packet_pkg_msi(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
    if (data_length == 0) {
        return;
    }
...
static void m_handle_packet_pkg_invite_groupchat(Messenger *m, const int i, const uint8_t *data, const uint16_t data_length, void *userdata)
{
#ifndef VANILLA_NACL
...
static int m_handle_packet(void *object, int i, const uint8_t *temp, uint16_t len, void *userdata)
{
    ...
    switch (packet_id) {
        case PACKET_ID_OFFLINE:
            m_handle_packet_pkg_offline(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_NICKNAME:
            m_handle_packet_pkg_nickname(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_STATUSMESSAGE:
            m_handle_packet_pkg_statusmessage(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_USERSTATUS:
            m_handle_packet_pkg_userstatus(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_TYPING:
            m_handle_packet_pkg_typing(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_MESSAGE:
            m_handle_packet_pkg_message(m, i, data, data_length, PACKET_ID_MESSAGE, userdata);
            break;

        case PACKET_ID_ACTION:
            m_handle_packet_pkg_message(m, i, data, data_length, PACKET_ID_ACTION, userdata);
            break;

        case PACKET_ID_INVITE_CONFERENCE:
            m_handle_packet_pkg_invite_conference(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_FILE_SENDREQUEST:
            m_handle_packet_pkg_file_sendrequest(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_FILE_CONTROL:
            m_handle_packet_pkg_file_control(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_FILE_DATA:
            m_handle_packet_pkg_file_data(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_MSI:
            m_handle_packet_pkg_msi(m, i, data, data_length, userdata);
            break;

        case PACKET_ID_INVITE_GROUPCHAT:
            m_handle_packet_pkg_invite_groupchat(m, i, data, data_length, userdata);
            break;
